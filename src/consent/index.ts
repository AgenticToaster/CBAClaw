...
// Phase 6a: Scope Chain Event Model
export type {
...
export type {
  ...
  ConfirmationReceipt,
  ConsentChainEntry,
  DetermineDetailLevelParams,
  EAAAdjudicationSummary,
...
export { determineDetailLevel, formatReceiptAsText, generateReceipt } from "./receipts.js";

// Phase 6d: Consent Flow Metrics
export type {
  HistogramBucket,
  MetricCounter,
  MetricHistogram,
